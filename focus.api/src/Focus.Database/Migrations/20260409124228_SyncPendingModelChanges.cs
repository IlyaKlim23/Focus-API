    ...
    public partial class SyncPendingModelChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PsychologicalQuestionnaireQuestions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PsychologicalQuestionnaires", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionnaireResponseItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuestionnaireSchedules", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PsychologicalQuestionnaireQuestions_QuestionnaireId_SortOrd~",
                table: "PsychologicalQuestionnaireQuestions",
                columns: new[] { "QuestionnaireId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_PsychologicalQuestionnaires_Code",
                table: "PsychologicalQuestionnaires",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireResponseItems_ResponseId_QuestionId",
                table: "QuestionnaireResponseItems",
                columns: new[] { "ResponseId", "QuestionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_QuestionnaireResponses_UserId_SubmittedAtUtc",
                table: "QuestionnaireResponses",
                columns: new[] { "UserId", "SubmittedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskNotifications_Status_ScheduledForUtc",
                table: "TaskNotifications",
                columns: new[] { "Status", "ScheduledForUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskNotifications_TaskId_SlotStart",
                table: "TaskNotifications",
                columns: new[] { "TaskId", "SlotStart" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserQuestionnaireSchedules_IsEnabled_NextDueAtUtc",
                table: "UserQuestionnaireSchedules",
                columns: new[] { "IsEnabled", "NextDueAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_UserQuestionnaireSchedules_UserId_QuestionnaireId",
                table: "UserQuestionnaireSchedules",
